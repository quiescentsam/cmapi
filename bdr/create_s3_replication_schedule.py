...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description="Adding Source cluster as peer in Destination Cloudera Manager ", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
